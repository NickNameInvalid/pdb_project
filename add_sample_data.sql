...
values ('user1', 'user1@mail.com', '42aff45bcfef506acda841c4c751a5e82376dc5e6b81d317aeafc4853eb4b768', 'f1', 'l1', '1112223333', 'New York', 'NY', 'USA', 'profile1', 50);
        
insert into Users (username, email, password, firstname, lastname, phone, city, state, country, profile, karma_points)
values ('user2', 'user2@mail.com', '956908ff8c5483d42acc0d332b89b86cf919f387eae8862b46fccc6594713bfb', 'f2', 'l2', '2223334444', 'Boston', 'MA', 'USA', 'profile2', 80);
        
insert into Users (username, email, password, firstname, lastname, phone, city, state, country, profile, karma_points)
values ('user3', 'user3@mail.com', '42aff45bcfef506acda841c4c751a5e82376dc5e6b81d317aeafc4853eb4b768', 'f3', 'l3', '3334445555', 'Los Angles', 'CA', 'USA', 'profile3', 120);
        
insert into Users (username, email, password, firstname, lastname, phone, city, state, country, profile, karma_points)
values ('user4', 'user4@mail.com', 'ed2047dfc9f23f56fe0c3af8996646b64a52b41d0afcba4a671831cf8d54dd69', 'f4', 'l4', '4445556666', 'New York', 'NY', 'USA', 'profile4', 90);
        
insert into Users (username, email, password, firstname, lastname, phone, city, state, country, profile, karma_points)
values ('user5', 'user5@mail.com', '64532608c19ae7a92a1cd9fb4f38dd29671955e0cc72925bef3b1e303a770b23', 'f5', 'l5', '5556667777', 'Boston', 'MA', 'USA', 'profile5', 80);
...
-- 17
insert into Questions (q_username, stid, title, q_body, post_time, status)
values ('user3', 14, 'is songwriting hard to study?', 'i am a freshmen in college', '2020-01-17 12:12:20', 'unsolved');

-- 18
insert into Questions (q_username, stid, title, q_body, post_time, status)
values ('user1', 14, 'songwriting is so easy', 'i am a musician', '2021-01-17 12:12:21', 'unsolved');

-- 19
insert into Questions (q_username, stid, title, q_body, post_time, status)
values ('user6', 14, 'songwriting is so easy', 'i am also a musician', '2021-01-17 12:12:22', 'unsolved');
