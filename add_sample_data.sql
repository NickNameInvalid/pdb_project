...
values ('user1', 'user1@mail.com', '42aff45bcfef506acda841c4c751a5e82376dc5e6b81d317aeafc4853eb4b768', 'f1', 'l1', '1112223333', 'New York', 'NY', 'USA', 'profile1', 5, 1);
        
insert into Users (username, email, password, firstname, lastname, phone, city, state, country, profile, karma_points, statusid)
values ('user2', 'user2@mail.com', '956908ff8c5483d42acc0d332b89b86cf919f387eae8862b46fccc6594713bfb', 'f2', 'l2', '2223334444', 'Boston', 'MA', 'USA', 'profile2', 10, 1);
        
insert into Users (username, email, password, firstname, lastname, phone, city, state, country, profile, karma_points, statusid)
values ('user3', 'user3@mail.com', '42aff45bcfef506acda841c4c751a5e82376dc5e6b81d317aeafc4853eb4b768', 'f3', 'l3', '3334445555', 'Los Angles', 'CA', 'USA', 'profile3', 63, 2);
        
insert into Users (username, email, password, firstname, lastname, phone, city, state, country, profile, karma_points, statusid)
values ('user4', 'user4@mail.com', 'ed2047dfc9f23f56fe0c3af8996646b64a52b41d0afcba4a671831cf8d54dd69', 'f4', 'l4', '4445556666', 'New York', 'NY', 'USA', 'profile4', 77, 2);
        
insert into Users (username, email, password, firstname, lastname, phone, city, state, country, profile, karma_points, statusid)
values ('user5', 'user5@mail.com', '64532608c19ae7a92a1cd9fb4f38dd29671955e0cc72925bef3b1e303a770b23', 'f5', 'l5', '5556667777', 'Boston', 'MA', 'USA', 'profile5', 31, 1);
        
insert into Users (username, email, password, firstname, lastname, phone, city, state, country, profile, karma_points, statusid)
values ('user6', 'user6@mail.com', 'be4b60459be9466dcaa973314cec00a3b97c2e481ba51f613cecd3b7cafc170f', 'f6', 'l6', '6667778888', 'Los Angles', 'CA', 'USA', 'profile6', 103, 3);
...
insert into Questions (q_username, stid, title, body, post_time, status) 
...
insert into Answers (qid, answer_time, a_username, body, thumb_ups, best_answer)
